...
#[cfg(windows)]
pub use mf_poster::{
    decode_video_poster, decode_video_poster_input, decode_video_poster_replay,
    decode_video_poster_select, probe_video_details, probe_video_details_input, probe_video_input,
    probe_video_stream,
};
#[cfg(windows)]
